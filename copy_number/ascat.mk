...
ascat : $(foreach pair,$(SAMPLE_PAIRS),ascat/log2/$(pair).pdf \
									   ascat/bafall/$(pair).pdf \
									   ascat/bafhet/$(pair).pdf \
									   ascat/mad/$(pair).RData \
									   ascat/log2nbaf/$(pair).pdf \
									   ascat/ascat/$(pair).pdf \
									   ascat/total/$(pair).pdf \
									   ascat/bychr/$(pair)/timestamp)

define ascat-plot-log2
ascat/log2/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 1G -m 2G,"$(RSCRIPT) modules/copy_number/ascat.R --type log2 \
												--file_in $$< \
...
ascat/bafall/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 1G -m 2G,"$(RSCRIPT) modules/copy_number/ascat.R --type bafall \
												--file_in $$< \
...
ascat/bafhet/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 1G -m 2G,"$(RSCRIPT) modules/copy_number/ascat.R --type bafhet \
												--file_in $$< \
...
ascat/mad/$1_$2.RData : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 3G -m 6G,"$(RSCRIPT) modules/copy_number/ascat.R --type aspcf \
												--file_in $$< \
...
ascat/log2nbaf/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v $(ASCAT_ENV) -s 3G -m 6G,"$(RSCRIPT) modules/copy_number/ascat.R --type plot-aspcf \
												--file_in $$< \
...
ascat/ascat/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v $(ASCAT_ENV) -s 3G -m 6G,"$(RSCRIPT) modules/copy_number/ascat.R --type run-ascat \
												--file_in $$< \
...
ascat/total/$1_$2.pdf : facets/cncf/$1_$2.Rdata ascat/ascat/$1_$2.pdf
	$$(call RUN,-c -v $(ASCAT_ENV) -s 6G -m 12G,"$(RSCRIPT) modules/copy_number/ascat.R --type total-copy \
												 --file_in $$< \
...
ascat/bychr/$1_$2/timestamp : facets/cncf/$1_$2.Rdata ascat/ascat/$1_$2.pdf
	$$(call RUN, -v $(ASCAT_ENV) -s 6G -m 12G,"mkdir -p ascat/bychr/ && \
											   ...
											   $(RSCRIPT) modules/copy_number/ascat.R --type plot-chr \
											   --file_in $$< \
