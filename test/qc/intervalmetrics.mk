...
metrics/standard/$1.ontarget.txt : bam/$1-standard.bam
	$$(call RUN,-n 4 -s 6G -m 8G,"cnvkit.py coverage -p 4 -q 0 $$(<) $$(ONTARGET_FILE) -o metrics/standard/$$(*).ontarget.txt")

metrics/standard/$1.offtarget.txt : bam/$1-standard.bam
	$$(call RUN,-n 4 -s 6G -m 8G,"cnvkit.py coverage -p 4 -q 0 $$(<) $$(OFFTARGET_FILE) -o metrics/standard/$$(*).offtarget.txt")
endef
