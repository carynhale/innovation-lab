...
POOL_A_BED_FILE ?= $(HOME)/share/reference/target_panels/MSK-ACCESS-v1_0-probe-A.
POOL_B_BED_FILE ?= $(HOME)/share/reference/target_panels/MSK-ACCESS-v1_0-probe-B.
...
metrics/standard/$1.insert_metrics.txt : bam/%-standard.bam
	$$(call RUN, -c -n 1 -s 12G -m 18G -w 1440,"java -Djava.io.tmpdir=$(TMPDIR) -Xms2G -Xmx16G -jar $$(PICARD_JAR) CollectInsertSizeMetrics \
												I=$$(<) \
												O=$$(@) \
												H=metrics/standard/$1.insert_size_histogram.pdf \
												M=0.5 \
												TMP_DIR=$(TMPDIR)")
...
metrics/standard/$1.pool-A.hs_metrics.txt : bam/%-standard.bam
	$$(call RUN, -c -n 1 -s 12G -m 18G -w 1440,"java -Djava.io.tmpdir=$(TMPDIR) -Xms2G -Xmx16G -jar $$(PICARD_JAR) CollectHsMetrics \
												...
												I=$$(<) \
												O=$$(@) \
												BAIT_INTERVALS=$(POOL_A_BED_FILE) \
												TARGET_INTERVALS=$(POOL_A_BED_FILE) \
												TMP_DIR=$(TMPDIR)")
...
metrics/standard/$1.pool-B.hs_metrics.txt : bam/%-standard.bam
	$$(call RUN, -c -n 1 -s 12G -m 18G -w 1440,"java -Djava.io.tmpdir=$(TMPDIR) -Xms2G -Xmx16G -jar $$(PICARD_JAR) CollectHsMetrics \
												...
												I=$$(<) \
												O=$$(@) \
												BAIT_INTERVALS=$(POOL_B_BED_FILE) \
												TARGET_INTERVALS=$(POOL_B_BED_FILE) \
												TMP_DIR=$(TMPDIR)")

endef
$(foreach sample,$(SAMPLES),\
		$(eval $(call picard,$(sample))))
