...
defuse/%.dedup.1.fastq defuse/%.dedup.2.fastq : %.bam
	$(call RUN,-n 4 -s 4G -m 9G,"$(SAMTOOLS) sort -T $(<D)/$* -O bam -n -@ 4 -m 6G $< | $(SAMTOOLS) fastq -f 1 -1 defuse/$*.dedup.1.fastq -2 defuse/$*.dedup.2.fastq")
