...
waltz/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX-pileup.txt.gz : bam/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX.bam
	$$(call RUN,-c -n 4 -s 4G -m 6G,"set -o pipefail && \
					 mkdir -p waltz && \
					 cd waltz && \
					 ln -sf ../bam/$1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX.bam $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX.bam && \
					 ln -sf ../bam/$1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX.bai $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX.bai && \
					 $$(call WALTZ_CMD,2G,8G) org.mskcc.juber.waltz.Waltz PileupMetrics $$(WALTZ_MIN_MAPQ) $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX.bam $$(REF_FASTA) $$(WALTZ_BED_FILE) && \
...
waltz/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_SIMPLEX-pileup.txt.gz : bam/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_SIMPLEX.bam
	$$(call RUN,-c -n 4 -s 4G -m 6G,"set -o pipefail && \
					 mkdir -p waltz && \
					 cd waltz && \
					 ln -sf ../bam/$1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_SIMPLEX.bam $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_SIMPLEX.bam && \
					 ...
					 $$(call WALTZ_CMD,2G,8G) org.mskcc.juber.waltz.Waltz PileupMetrics $$(WALTZ_MIN_MAPQ) $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_SIMPLEX.bam $$(REF_FASTA) $$(WALTZ_BED_FILE) && \
...
waltz/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_DUPLEX-pileup.txt.gz : bam/$1_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_DUPLEX.bam
	$$(call RUN,-c -n 4 -s 4G -m 6G,"set -o pipefail && \
					 mkdir -p waltz && \
					 cd waltz && \
					 ln -sf ../bam/$1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_DUPLEX.bam $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_DUPLEX.bam && \
					 ...
					 $$(call WALTZ_CMD,2G,8G) org.mskcc.juber.waltz.Waltz PileupMetrics $$(WALTZ_MIN_MAPQ) $1_cl_aln_srt_MD_IR_FX2_BR__grp_DC_MA_RG_IR_FX_DUPLEX.bam $$(REF_FASTA) $$(WALTZ_BED_FILE) && \
...
summary/intervals_summary.txt : $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_FX_BR-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_SIMPLEX-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_DUPLEX-pileup.txt.gz)
	$(call RUN, -c -n 1 -s 64G -m 128G,"set -o pipefail && \
					    $(RSCRIPT) $(SCRIPTS_DIR)/qc/pileup_metrics.R --library 'PRISM' --option 1 --sample_names '$(SAMPLES)'")
summary/pileup_summary_standard.txt : $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_FX_BR-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_SIMPLEX-pileup.txt.gz) $(foreach sample,$(SAMPLES),waltz/$(sample)_cl_aln_srt_MD_IR_$(FX)_BR__grp_DC_MA_RG_IR_FX_DUPLEX-pileup.txt.gz)
	$(call RUN, -c -n 1 -s 64G -m 128G,"set -o pipefail && \
					    $(RSCRIPT) $(SCRIPTS_DIR)/qc/pileup_metrics.R --library 'PRISM' --option 2 --sample_names '$(SAMPLES)'")
